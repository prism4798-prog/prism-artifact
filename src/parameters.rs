...
impl Parameters {
    ...
    pub fn from_curve<P: PrimeField>() -> Result<(Parameters, u16), ParametersError> {
        let field_size_bits = P::MODULUS_BIT_SIZE as usize as u16;
    ...
    pub fn from_curve_and_small_prime_size<P: PrimeField>(
        prime_bits_min: u16,
        prime_bits_max: u16,
